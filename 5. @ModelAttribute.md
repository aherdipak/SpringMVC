...
### Example :
 * `SpringMVC_ModelAttribute` directory
 
 ##### Input :
 ![image](https://user-images.githubusercontent.com/35020560/55674533-9f91ff80-58d3-11e9-8a8b-32b2cd9531e6.png)

 ##### Output :
 
 ![image](https://user-images.githubusercontent.com/35020560/55674549-c2bcaf00-58d3-11e9-9ac0-dd90bd04df97.png)
