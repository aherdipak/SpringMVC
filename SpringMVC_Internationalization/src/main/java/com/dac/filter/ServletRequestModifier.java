...
public class ServletRequestModifier extends HttpServletRequestWrapper {
	 ...
	 */
	public ServletRequestModifier(final HttpServletRequest request, final Map<String, String[]> additionalParams) {
		super(request);
